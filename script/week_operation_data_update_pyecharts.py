...
if __name__ == "__main__":
    ...
    for i in range(len(site_list)):
        ...
        res_vehicle_list.append(execute_sql(sql_vehicle_list[i]))
        res_duration_list.append(execute_sql(sql_duration_list[i]))
        res_distance_list.append(execute_sql(sql_distance_list[i]))
        res_duration_avg_list.append(execute_sql(sql_duration_avg_list[i]))
    ...
    res_static = execute_sql(sql_static)
